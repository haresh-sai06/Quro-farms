...
export const products: Product[] = [
  ...
  recipeIdeas: [
    ...
    { name: 'Face Mask', method: 'Mix turmeric powder with honey or yogurt for a natural glow.' },
...
},
{
  ...
  recipeIdeas: [
    ...
    { name: 'Soup Thickener', method: 'Stir raw banana powder into soups for a natural thickener.' }
  ],
  ...
  { name: 'Fruit Jelly', method: 'Combine fruit juice with arrowroot powder for a clear, natural jelly.' }
],
  ...
  { name: 'Desserts', method: 'Use jackfruit powder in traditional sweets for natural flavor and color.' },

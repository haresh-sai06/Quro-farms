  ...
  const FloatingBackButton: React.FC = () => {
    ...
    return (
      <motion.div
        ...
        transition={{ type: "spring", stiffness: 300, damping: 30 }}
        className="hidden sm:block bottom-28 right-4 z-50" // Hide on mobile
      >
        <Link
          to="/products"
              ...
              >
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-md sm:text-lg text-white/80 text-center">per {product.unit}</div>
                  </div>
                ...
                <div className="grid gap-6 sm:gap-12 items-center">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="space-y-2 sm:space-y-4">
                      ...
                      <p className="text-neutral-600 text-sm sm:text-lg text-center">per {product.unit}</p>
                    </div>

...
const Navbar = () => {
  ...
  return (
    <motion.header
      ...
      style={{
        backgroundImage: !isMenuOpen ? `linear-gradient(rgba(0, 128, 0, 0.3), rgba(0, 128, 0, 0.3)), url('https://images.unsplash.com/photo-1500595046743-4c3542c2a7f5')` : 'none',
    ...
    >
      <nav className="container-padding mx-auto flex h-20 items-center justify-between">
        ...
        >
          ...
          <span className={isMenuOpen ? 'text-green-700' : 'text-green-700'}>Quro Farms</span>
        </motion.a>

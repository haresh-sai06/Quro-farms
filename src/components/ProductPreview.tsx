                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <motion.button
                      ...
                      className="flex-1 btn-custom-color text-black py-3 rounded-xl hover:bg-yellow-700 transition-all duration-300 font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed"
